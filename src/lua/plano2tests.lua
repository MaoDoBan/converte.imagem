...
-- Dict={a="3de",...};
-- Dados={
--   {"x","y",0,0,0,100,"abfasdfasgSKFFAMSOFImisisjdfisaADFAd,fa"},
--   {}...
-- };



local function geraBlocos()end

local function converteBase36PraBlocos()end

local function converteEGera()
  ;
end
...
local function clique(evento)
  ...
  geraImagem({evento.x, evento.y, evento.z});
end
